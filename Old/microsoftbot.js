console.log("The mircrosoft bot is starting")
 ...
 * @param {hello} text The text to be corrected
            ...
            if (text) {
              console.log("yes there is text");
                ...
                request.post(requestData, (error, response, body) => {
                    ...
                    var json = JSON.stringify(requestData,null,2);  //write JSON 2/3
                    fs.writeFile("spell.JSON", json);  //write JSON 3/3
